...
if __name__ == '__main__':
    ...
    if args.img_type == "vit":
        ...
        detr_model.eval()
    elif args.img_type == "deformable_detr":
        deformable_detr_processor = AutoImageProcessor.from_pretrained("SenseTime/deformable-detr-with-box-refine-two-stage")
        deformable_detr_model = DeformableDetrForObjectDetection.from_pretrained("SenseTime/deformable-detr-with-box-refine-two-stage")
